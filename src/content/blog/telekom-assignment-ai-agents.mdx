...
description: Handing an AI agent the keys, no supervision, to write tests and rebuild the UI from Figma screenshots.
---
...
things by quietly _removing_ several bind mounts (`.gradle`, `build`, `just/`, the `Justfile`)
