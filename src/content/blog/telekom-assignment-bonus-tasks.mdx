...
publishedAt: 2026-07-25T20:00
description: Tackling the optional bonus tasks, a local database, a sync scheduler, and production readiness.
---
...
Somewhere along the way I also hardened an XML pretty-printer against XXE attacks and added
log redaction so Wi-Fi passwords never reached disk. Neither problem was ever likely
