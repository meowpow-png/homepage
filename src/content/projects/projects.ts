...
export const projects = [
  {Content: WifiAdminContent, metadata: getMetadata<ProjectMetadata>(wifiAdminMetadata)},
  {Content: TaskRunnerContent, metadata: getMetadata<ProjectMetadata>(taskRunnerMetadata)},
  {Content: DotfilesContent, metadata: getMetadata<ProjectMetadata>(dotfilesMetadata)},
  {Content: ReleaseMonitorContent, metadata: getMetadata<ProjectMetadata>(releaseMonitorMetadata)},
] as const
