...
export function App(): JSX.Element {
  ...
  const currentPage = resolveCurrentPage(route, blogPost !== undefined)
  return (
    <RouterContext.Provider value={navigation}>
      <AppShell header={<Navigation currentPage={currentPage} />} footer={<Footer />}>
...
export function renderPage(route: Route | undefined, blogPost: BlogPost | undefined): ReactNode {
  if (route) {
    return route.render()
  }
  if (blogPost) {
