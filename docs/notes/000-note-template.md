...
{{ describe the objective, implementation task, experiment, or question that prompted these notes }}
...
{{ summarize the key technical findings. Clearly distinguish what was confirmed,
what was ruled out, and any root cause or important insight that was identified }}
