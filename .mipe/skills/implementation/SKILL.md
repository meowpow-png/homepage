---
name: implementation
description: Implements and refactors TypeScript code Use when writing code implementation.
---

When writing or refactoring code follow these conventions
...
- Add explicit return types to exported function.
